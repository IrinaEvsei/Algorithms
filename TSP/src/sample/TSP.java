...
public class TSP {
    ...
    private List<? extends TSPPoint> points; // First element in labels must be home position (0,0)
    ...
    public TSP(List<? extends TSPPoint> labels) {
        this(labels, 1, 1);
    }
    ...
    public TSP(List<? extends TSPPoint> points, int costX, int costY) {
        done = new AtomicLong();
